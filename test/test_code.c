...
#define test_arithmetic_multiplication(lhs, rhs, product, size, assert_function)    do { \
    ...
    test_arithmetic_multiplication(9223372036854775808UL, 3UL, 9223372036854775808UL, 8, assert_equal_unsigned_long);

#undef test_arithmetic_multiplication

#define test_arithmetic_division(lhs, rhs, quotient, size, assert_function)    do { \
    assert_size_of_expression(size, lhs / rhs); \
    assert_function(quotient, lhs / rhs); \
    } while(0)
...
#define test_arithmetic_modulation(lhs, rhs, remainder, size, assert_function)    do { \
    assert_size_of_expression(size, lhs % rhs); \
    assert_function(remainder, lhs % rhs); \
    } while(0)
    ...
    test_arithmetic_modulation((signed char)126, (signed char)127, 126, 4, assert_equal_int);
    test_arithmetic_modulation((unsigned char)255, (unsigned char)1, 0, 4, assert_equal_int);
    ...
    test_arithmetic_modulation((short)32766, (short)32767, 32766, 4, assert_equal_int);
    test_arithmetic_modulation((unsigned short)65535, (unsigned short)1, 0, 4, assert_equal_int);
    ...
    test_arithmetic_modulation(2147483646, 2147483647, 2147483646, 4, assert_equal_int);
    test_arithmetic_modulation(4294967295U, 1U, 0U, 4, assert_equal_unsigned_int);
    ...
    test_arithmetic_modulation(9223372036854775806L, 9223372036854775807L, 9223372036854775806L, 8, assert_equal_long);
    test_arithmetic_modulation(18446744073709551615UL, 1UL, 0UL, 8, assert_equal_unsigned_long);
    test_arithmetic_modulation(18446744073709551615UL, 2UL, 1UL, 8, assert_equal_unsigned_long);
    test_arithmetic_modulation(18446744073709551615UL, 18446744073709551615UL, 0UL, 8, assert_equal_unsigned_long);
    test_arithmetic_modulation(18446744073709551614UL, 18446744073709551615UL, 18446744073709551614UL, 8, assert_equal_unsigned_long);
...
#define assert_arithmetic_addition(lhs, rhs, sum, size, assert_function)    do { \
    assert_size_of_expression(size, lhs + rhs); \
    assert_size_of_expression(size, rhs + lhs); \
    assert_function(sum, lhs + rhs); \
    assert_function(sum, rhs + lhs); \
    } while(0)
#define test_arithmetic_addition(type, lhs, rhs, sum, size, assert_function)    do { \
    type lhs_var = (type)lhs; \
    type rhs_var = (type)rhs; \
    assert_arithmetic_addition((type)lhs, (type)rhs, sum, size, assert_function); \
    assert_arithmetic_addition((type)lhs, rhs_var, sum, size, assert_function); \
    assert_arithmetic_addition(lhs_var, (type)rhs, sum, size, assert_function); \
    assert_arithmetic_addition(lhs_var, rhs_var, sum, size, assert_function); \
    } while(0)
...
#define assert_arithmetic_subtraction(lhs, rhs, difference, size, assert_function)    do { \
    assert_size_of_expression(size, lhs - rhs); \
    assert_function(difference, lhs - rhs); \
    } while(0)
#define test_arithmetic_subtraction(type, lhs, rhs, difference, size, assert_function)    do { \
    type lhs_var = (type)lhs; \
    type rhs_var = (type)rhs; \
    assert_arithmetic_subtraction((type)lhs, (type)rhs, difference, size, assert_function); \
    assert_arithmetic_subtraction((type)lhs, rhs_var, difference, size, assert_function); \
    assert_arithmetic_subtraction(lhs_var, (type)rhs, difference, size, assert_function); \
    assert_arithmetic_subtraction(lhs_var, rhs_var, difference, size, assert_function); \
    } while(0)
